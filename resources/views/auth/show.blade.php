...
<div class="container">
    ...
    <ul class="nav nav-tabs justify-content-center mt-5">
        <li class="nav-item"><a href="#entries_div" class="nav-link active" data-toggle="tab">投稿一覧</a></li>
        <li class="nav-item"><a href="#likes_div" class="nav-link" data-toggle="tab">いいね！一覧</a></li>
    </ul>
    <div class="tab-content py-4">
        <div id="entries_div" class="tab-pane active">
        ...
        <div id="likes_div" class="tab-pane">
            <div class="card-deck mt-3">
