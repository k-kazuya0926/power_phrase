                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('entries') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="source" type="source" class="form-control @error('source') is-invalid @enderror" name="source" value="{{ old('source') }}" autocomplete="source">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="episode" type="episode" class="form-control @error('episode') is-invalid @enderror" name="episode" rows="5"></textarea>
